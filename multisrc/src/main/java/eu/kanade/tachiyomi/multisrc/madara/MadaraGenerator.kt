...
class MadaraGenerator : ThemeSourceGenerator {
    ...
    override val sources = listOf(
        ...
        SingleLang("Okamishi Scans", "https://geassscan.net", "pt-BR", pkgName = "geassscanlator", overrideVersionCode = 4),
        ...
        SingleLang("Reader's Point", "https://readers-point.space", "en", className = "Reader's Point"),
